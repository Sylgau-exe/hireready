...
const FROM_EMAIL = process.env.FROM_EMAIL || 'HireReady <noreply@hireready.online>';
...
export async function sendPasswordResetEmail({ name, email, resetToken, resetUrl }) {
  ...
  const fullResetUrl = resetUrl || `https://hireready.online?reset_token=${resetToken}`;
  const html = `
...
export async function sendWelcomeEmail({ name, email }) {
    ...
    <!DOCTYPE html><html><head><style>
      ...
      <div class="container"><div class="card">
        ...
        <div class="content">
          ...
          <div class="cta"><a href="https://hireready.online/dashboard">Go to Dashboard →</a></div>
  ...
  return sendEmail({
    ...
    html,
    text: `Welcome to HireReady! Go to your dashboard: https://hireready.online/dashboard`,
    replyTo: ADMIN_EMAIL,
  });
}
